...
if __name__ == '__main__':
    ...
    slope,eMSD_for_fit=msd.MSD_fitting(tau,eMSD_for,'MSD_fit')
    polyorder,eMSD_for_fit_log=msd.MSD_fitting(tau,eMSD_for,'loglog_fit')
    
    fig,axes=plt.subplots(1,2,figsize=(8,6))
    axes[0].plot(tau,eMSD_for,label="data(nParticles="+str(nParticles)+")")
    axes[0].plot(tau,eMSD_for_fit,'r--',lw=1,label='fitting')
    ...
    axes[1].plot(tau,eMSD_for_fit_log,'--',Label='fitting')
    ...
    slope,eMSD_vect_fit=msd.MSD_fitting(tau,eMSD_vect,'MSD_fit')
    polyorder,eMSD_vect_fit_log=msd.MSD_fitting(tau,eMSD_vect,'loglog_fit')
    
    fig,axes=plt.subplots(1,2,figsize=(8,6))
    axes[0].plot(tau,eMSD_vect,label="data(nParticles="+str(nParticles)+")")
    axes[0].plot(tau,eMSD_vect_fit,'r--',lw=1,label='fitting')
    axes[0].grid(linewidth=0.3)
    axes[0].legend()
    axes[0].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[0].set_ylabel('eMSD [$\mu m^2$]',fontweight='bold')
    ...
    axes[1].plot(tau,eMSD_vect_fit_log,'--',Label='fitting')
    axes[1].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[1].grid(lw=0.3)
    axes[1].set_yscale('log')
    axes[1].set_xscale('log')
    ...
    slope,time_eMSD_for_fit=msd.MSD_fitting(tau,time_eMSD_for,'MSD_fit')
    polyorder,time_eMSD_for_fit_log=msd.MSD_fitting(tau,time_eMSD_for,'loglog_fit')
    
    fig,axes=plt.subplots(1,2,figsize=(8,6))
    axes[0].plot(tau,time_eMSD_for,label="data(nParticles="+str(nParticles)+")")
    axes[0].plot(tau,time_eMSD_for_fit,'r--',lw=1,label='fitting')
    axes[0].grid(linewidth=0.3)
    axes[0].legend()
    axes[0].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    ...
    axes[1].plot(tau,time_eMSD_for_fit_log,'--',Label='fitting')
    axes[1].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[1].grid(lw=0.3)
    axes[1].set_yscale('log')
    axes[1].set_xscale('log')
    ...
    slope,time_eMSD_vect_fit=msd.MSD_fitting(tau,time_eMSD_vect,'MSD_fit')
    polyorder,time_eMSD_vect_fit_log=msd.MSD_fitting(tau,time_eMSD_vect,'loglog_fit')
    
    fig,axes=plt.subplots(1,2,figsize=(8,6))
    axes[0].plot(tau,time_eMSD_vect,label="data(nParticles="+str(nParticles)+")")
    axes[0].plot(tau,time_eMSD_vect_fit,'r--',lw=1,label='fitting')
    axes[0].grid(linewidth=0.3)
    axes[0].legend()
    axes[0].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[0].set_ylabel('time-averaged eMSD [$\mu m^2$]',fontweight='bold')
    ...
    axes[1].plot(tau,time_eMSD_vect_fit_log,'--',Label='fitting')
    axes[1].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[1].grid(lw=0.3)
    axes[1].set_yscale('log')
    axes[1].set_xscale('log')
    ...
    slope,time_eMSD_parallel_fit=msd.MSD_fitting(tau,time_eMSD_parallel,'MSD_fit')
    polyorder,time_eMSD_parallel_fit_log=msd.MSD_fitting(tau,time_eMSD_parallel,'loglog_fit')
    
    fig,axes=plt.subplots(1,2,figsize=(8,6))
    axes[0].plot(tau,time_eMSD_parallel,label="data(nParticles="+str(nParticles)+")")
    axes[0].plot(tau,time_eMSD_parallel_fit,'r--',lw=1,label='fitting')
    axes[0].grid(linewidth=0.3)
    axes[0].legend()
    axes[0].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[0].set_ylabel('time-averaged eMSD [$\mu m^2$]',fontweight='bold')
    ...
    axes[1].plot(tau,time_eMSD_parallel_fit_log,'--',Label='fitting')
    axes[1].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[1].grid(lw=0.3)
    axes[1].set_yscale('log')
    axes[1].set_xscale('log')
    ...
    slope,time_eMSD_gpu_fit=msd.MSD_fitting(tau,time_eMSD_gpu,'MSD_fit')
    polyorder,time_eMSD_gpu_fit_log=msd.MSD_fitting(tau,time_eMSD_gpu,'loglog_fit')
    
    fig,axes=plt.subplots(1,2,figsize=(8,6))
    axes[0].plot(tau,time_eMSD_gpu,label="data(nParticles="+str(nParticles)+")")
    axes[0].plot(tau,time_eMSD_gpu_fit,'r--',lw=1,label='fitting')
    axes[0].grid(linewidth=0.3)
    axes[0].legend()
    axes[0].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[0].set_ylabel('time-averaged eMSD [$\mu m^2$]',fontweight='bold')
    ...
    axes[1].plot(tau,time_eMSD_gpu_fit_log,'--',Label='fitting')
    axes[1].set_xlabel('$\Delta t$ [sec]',fontweight='bold')
    axes[1].grid(lw=0.3)
    axes[1].set_yscale('log')
    axes[1].set_xscale('log')
